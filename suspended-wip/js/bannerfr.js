...
const sketchD = (p) => {
    ...
    p.setup = () => {
        ...
        d = p.createCanvas(p.windowWidth, p.windowHeight * .55);
    ...
    p.draw = () => {
        ...
        let namesWidth = p.textWidth("     " + "COMING SOON..." + "     ");
        ...
        for (let x = xLeft; x < p.width; x += namesWidth) {
            ...
            for (let i = 1; i <= totalRows; i += 2) {
                ...
                for (let i = 0; i < p.text.length; i++) {
                    p.text("     " + "COMING SOON..." + "     ", x, rowHeight * i);
    ...
    p.windowResized = () => {
        ...
        p.resizeCanvas(p.windowWidth, p.windowHeight * .55);
        rowHeight = p.windowHeight * .55;
        p.textSize(rowHeight);
